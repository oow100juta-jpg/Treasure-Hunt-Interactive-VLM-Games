  ...
  return (
    <main>
      ...
      <section className="mx-auto grid min-h-[calc(100dvh-80px)] max-w-6xl items-center gap-10 px-5 pb-16 pt-8 md:grid-cols-[1.05fr_.95fr] md:py-16">
        <div>
          <p className="kicker mb-5">AI-powered team scavenger hunt</p>
          ...
          <a href="#join" className="mt-8 inline-flex items-center gap-2 text-sm font-black uppercase tracking-widest">Find your room <ArrowDown size={18} /></a>
        </div>
      ...
      <section id="join" className="bg-kcv-peach px-5 py-20"><div className="mx-auto grid max-w-5xl items-center gap-12 md:grid-cols-2"><div><p className="kicker">One room. One clock.</p><h2 className="display mt-3 text-5xl leading-none md:text-7xl">Your team’s next story starts here.</h2><p className="mt-5 max-w-md text-zinc-700">Ask your game host for the room code. Team names must be unique inside each room.</p></div><JoinForm /></div></section>
