...
export default function HomePage() {
  return (
    <main>
      <nav className="mx-auto flex max-w-6xl items-center justify-between px-5 py-5"><div className="flex items-center gap-3">{/*  */}<span className="display text-lg">Vision Hunt</span></div><Link href="/admin" className="text-sm font-bold underline decoration-2 underline-offset-4">Admin portal</Link></nav>
      ...
      <footer className="flex items-center justify-between bg-black px-5 py-6 text-xs text-white"><span>©VISION HUNT</span><span>SEARCH · SEE · SNAP</span></footer>
    </main>
  );
}
